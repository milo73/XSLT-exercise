...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	<xsl:param name="commandToPublishVersion" select="'V3.2'"/>	
	<xsl:param name="noContentFoundString" select="'No content found for: '"/>
	
	<!--+
	      | This stylesheet transforms a commandToPublish 3.1 composition message into a commandToPublish 3.2 superProfile.		 
		  +-->
	<xsl:template match="/">
		<xsl:apply-templates/>
	</xsl:template>
